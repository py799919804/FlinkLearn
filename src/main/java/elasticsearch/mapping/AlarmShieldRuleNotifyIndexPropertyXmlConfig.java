...
/**
 * 
 * @ClassName:     AlarmShieldRuleNotifyIndexPropertyXmlConfig
 * @Description:   屏蔽规则通知记录
 * 
 * @company        北京神州泰岳软件股份有限公司
 * @author         caijinpeng
 * @email          caijinpeng@ultrapower.com.cn
 * @version        V1.0
 * @Date           2018年9月19日 下午3:19:15
 */
public class AlarmShieldRuleNotifyIndexPropertyXmlConfig extends IndexPropertyXmlConfig {
	// 日志
	private static Logger log = LoggerFactory.getLogger(AlarmShieldRuleNotifyIndexPropertyXmlConfig.class);

	public static final String CONFIG_FILE = "es_fm_alarmshieldrule_notifyrecord_mapping.xml";

	private static AlarmShieldRuleNotifyIndexPropertyXmlConfig instance = null;

	public static AlarmShieldRuleNotifyIndexPropertyXmlConfig getInstance() {
		if (instance == null) {
			synchronized (AlarmShieldRuleNotifyIndexPropertyXmlConfig.class) {
				if (instance == null) {
					instance = new AlarmShieldRuleNotifyIndexPropertyXmlConfig();
				}
			}
		}
		return instance;
	...
	private AlarmShieldRuleNotifyIndexPropertyXmlConfig() {
