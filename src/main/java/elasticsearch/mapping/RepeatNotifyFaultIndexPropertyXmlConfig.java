 ...
 */
public class RepeatNotifyFaultIndexPropertyXmlConfig extends IndexPropertyXmlConfig {
	// 日志
	private static Logger log = LoggerFactory.getLogger(RepeatNotifyFaultIndexPropertyXmlConfig.class);

	public static final String CONFIG_FILE = "es_fm_repeatnotifyrecord_mapping.xml";

	private static RepeatNotifyFaultIndexPropertyXmlConfig instance = null;

	public static RepeatNotifyFaultIndexPropertyXmlConfig getInstance() {
		if (instance == null) {
			synchronized (RepeatNotifyFaultIndexPropertyXmlConfig.class) {
				if (instance == null) {
					instance = new RepeatNotifyFaultIndexPropertyXmlConfig();
				}
			}
		}
		return instance;
	...
	private RepeatNotifyFaultIndexPropertyXmlConfig() {
