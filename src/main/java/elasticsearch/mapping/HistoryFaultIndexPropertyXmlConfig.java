...
/**
 * 
 * @ClassName:     HistoryFaultIndexPropertyXmlConfig
 * @Description:   历史告警索引
 * 
 ...
 * @version        V1.0
 * @Date           2018年9月19日 下午3:18:25
 */
public class HistoryFaultIndexPropertyXmlConfig extends IndexPropertyXmlConfig {
	// 日志
	private static Logger log = LoggerFactory.getLogger(HistoryFaultIndexPropertyXmlConfig.class);

	public static final String CONFIG_FILE = "es_fm_historyalert_mapping.xml";

	private static HistoryFaultIndexPropertyXmlConfig instance = null;

	public static HistoryFaultIndexPropertyXmlConfig getInstance() {
		if (instance == null) {
			synchronized (HistoryFaultIndexPropertyXmlConfig.class) {
				if (instance == null) {
					instance = new HistoryFaultIndexPropertyXmlConfig();
				}
			}
		}
		return instance;
	...
	private HistoryFaultIndexPropertyXmlConfig() {
