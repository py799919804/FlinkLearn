 ...
 * 告警升级索引
 * 
 * @ClassName: UpgradeFaultIndexPropertyXmlConfig
 * @Description: TODO
 * @author lijianye
 * @date 2018年4月28日 下午2:21:20
 *
 */
public class UpgradeFaultIndexPropertyXmlConfig extends IndexPropertyXmlConfig {
	// 日志
	private static Logger log = LoggerFactory.getLogger(UpgradeFaultIndexPropertyXmlConfig.class);

	public static final String CONFIG_FILE = "es_fm_upgraderecord_mapping.xml";

	private static UpgradeFaultIndexPropertyXmlConfig instance = null;

	public static UpgradeFaultIndexPropertyXmlConfig getInstance() {
		if (instance == null) {
			synchronized (UpgradeFaultIndexPropertyXmlConfig.class) {
				if (instance == null) {
					instance = new UpgradeFaultIndexPropertyXmlConfig();
				}
			}
		}
		return instance;
	...
	private UpgradeFaultIndexPropertyXmlConfig() {
