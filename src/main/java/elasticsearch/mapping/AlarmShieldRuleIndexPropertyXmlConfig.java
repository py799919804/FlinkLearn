...
/**
 * 
 * @ClassName:     AlarmShieldRuleIndexPropertyXmlConfig
 * @Description:   告警屏蔽规则索引
 * 
 * @company        北京神州泰岳软件股份有限公司
 * @author         caijinpeng
 * @email          caijinpeng@ultrapower.com.cn
 * @version        V1.0
 * @Date           2018年9月19日 下午3:18:01
 */
public class AlarmShieldRuleIndexPropertyXmlConfig extends IndexPropertyXmlConfig {
	// 日志
	private static Logger log = LoggerFactory.getLogger(AlarmShieldRuleIndexPropertyXmlConfig.class);

	public static final String CONFIG_FILE = "es_fm_alarmshieldrule_mapping.xml";

	private static AlarmShieldRuleIndexPropertyXmlConfig instance = null;

	public static AlarmShieldRuleIndexPropertyXmlConfig getInstance() {
		if (instance == null) {
			synchronized (AlarmShieldRuleIndexPropertyXmlConfig.class) {
				if (instance == null) {
					instance = new AlarmShieldRuleIndexPropertyXmlConfig();
				}
			}
		}
		return instance;
	...
	private AlarmShieldRuleIndexPropertyXmlConfig() {
