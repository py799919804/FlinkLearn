 ...
 */
public class ESConfiguration52 {
//    public static final Logger logger = LoggerFactory.getLogger(ESConfiguration52.class);
//
...
//
//
//    public ESConfiguration52(String esTransPorts, String clusterName, int maxActions){
//        if(maxActions < 5000){
//            maxActions = 5000;
//        }
...
//
//        if (null == client) {
//            synchronized(ESConfiguration52.class) {
//                initClient();
//            }
//        }
//        initBulkProcessor();
...
//
//            //client.addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("192.168.95.114"), Integer.parseInt("58940")));
//            client.addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("192.168.95.114"), Integer.parseInt("58940")));
//
//        }catch (Exception ex){
//            ex.printStackTrace();
